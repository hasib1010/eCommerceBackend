...
const DashboardNavbar = () => {
    return (
        <div className='sticky top-0 left-0 border p-10 shadow-lg rounded-xl flex flex-col gap-10  bg-white'>
            ...
            <NavLink to={'/customers'} className={"text-xl flex items-center gap-4  font-semibold text-gray-600"}><HiUserGroup  className='text-3xl' /> Customers</NavLink>
